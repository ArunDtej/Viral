		...
		if (navigator.share) {
			navigator
				.share({
					...
					text: `Hey ${data.prediction.user_data.name}, I just found out I'm a ${catData.name}!`,
...
<svelte:head>
	...
	<meta name="description" content={`I am a ${catData.name}`} />
</svelte:head>
...
<div class="page-container relative z-10">
	<div class="form-container" class:animate-slide-in-up={mounted}>
		...
		<div class="button-group">
			<a href="/viral/what-cat-are-you" class="secondary-btn">
				<RefreshCw size={20} />
				<span>Try Again</span>
			</a>
